                    ...
                    <div class="md:col-span-5">
                        ...
                        <select id="mercado_nombre" name="mercado_nombre" required class="input-tlalpan w-full rounded-xl py-3 px-4 text-sm font-bold border-gray-200 bg-white">
                            ...
                            <optgroup label="Mercados públicos (21)">
                                <option value="0263 - VILLA COAPA">VILLA COAPA</option>
                                <option value="0267 - FUENTES BROTANTES">FUENTES BROTANTES</option>
                                <option value="0289 - MIGUEL HIDALGO">MIGUEL HIDALGO</option>
                                <option value="0256 - DR. Y GRAL. JOSÉ GONZÁLEZ VARELA">DR. Y GRAL. JOSÉ GLEZ. VARELA</option>
                                <option value="0265 - LÁZARO CÁRDENAS">LÁZARO CÁRDENAS</option>
                                <option value="0286 - FLORES SAN FERNANDO">FLORES SAN FERNANDO</option>
                                <option value="0285 - SAN ANDRÉS TOTOLTEPEC">SAN ANDRÉS TOTOLTEPEC</option>
                                <option value="0392 - PLAZA MEXICANA DEL SUR">PLAZA MEXICANA DEL SUR</option>
                                <option value="0320 - TORRES DE PADIERNA">TORRES DE PADIERNA</option>
                                <option value="0350 - SAN NICOLÁS TOTOLAPAN">SAN NICOLÁS TOTOLAPAN</option>
                                <option value="0394 - VEINTICUATRO DE FEBRERO">24 DE FEBRERO</option>
                                <option value="1012 - VEINTIUNO DE ABRIL">21 DE ABRIL</option>
                                <option value="1011 - MIRADOR">EL MIRADOR</option>
                                <option value="0251 - COMIDAS HUIPULCO">COMIDAS HUIPULCO</option>
                                <option value="0393 - HUESO PERIFÉRICO">HUESO PERIFÉRICO</option>
                                <option value="0391 - JOSÉ MARÍA MORELOS Y PAVÓN">JOSÉ MA. MORELOS Y PAVÓN</option>
                                <option value="0042 - LA PAZ">LA PAZ</option>
                                <option value="0355 - MARGARITA MAZA DE JUÁREZ">MARGARITA MAZA DE JUÁREZ</option>
                                <option value="0406 - TLALCOLIGIA">TLALCOLIGIA</option>
                                <option value="0274 - ARTESANÍAS VASCO DE QUIROGA">ARTESANÍAS VASCO DE QUIROGA</option>
                                <option value="0282 - ISIDRO FABELA">ISIDRO FABELA</option>
                            </optgroup>
