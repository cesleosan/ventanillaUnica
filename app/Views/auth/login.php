<div class="min-h-screen flex flex-col items-center justify-center bg-gray-50 p-6 relative overflow-hidden">
    ...
    <div class="max-w-md mx-auto w-full relative z-10 animate-fade-in-up">
        
        <div class="bg-white rounded-[2.5rem] shadow-[0_25px_60px_-15px_rgba(119,51,87,0.15)] overflow-hidden border border-gray-100">
            
            <div class="bg-tlalpan-vino p-10 text-center relative">
                <div class="absolute top-0 right-0 w-32 h-32 bg-white/5 rounded-full -mr-16 -mt-16"></div>
                
                <div class="inline-block bg-white p-4 rounded-2xl shadow-xl mb-6 transform -rotate-2 hover:rotate-0 transition-transform duration-500">
                    <img src="/logos/Logo AT Vertical guinda 100 PX.png" alt="Alcaldía Tlalpan" class="h-20 w-auto">
                </div>
                
                <h2 class="text-white text-2xl font-black tracking-tight uppercase">Ventanilla Única</h2>
                <div class="flex items-center justify-center gap-2 mt-2">
                    <span class="h-[1px] w-8 bg-white/30"></span>
                    <p class="text-white/70 text-[10px] font-bold uppercase tracking-[0.3em]">Acceso Administrativo</p>
                    <span class="h-[1px] w-8 bg-white/30"></span>
                </div>
            </div>
                ...
                <form method="POST" action="/" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="username" placeholder="EJ. SISTEMAS" 
                            class="input-tlalpan w-full px-5 py-4 text-sm font-semibold focus:ring-2 focus:ring-tlalpan-vino/20 outline-none">
                    </div>

                    <div>
                        <label class="block text-[10px] font-black text-gray-400 uppercase mb-2 ml-1 tracking-widest">Contraseña</label>
                        <input type="password" name="password" placeholder="••••••••" 
                            class="input-tlalpan w-full px-5 py-4 text-sm focus:ring-2 focus:ring-tlalpan-vino/20 outline-none">
                    </div>
                    ...
                    <div class="bg-[#FCF7F9] p-4 rounded-2xl border border-[#E6D4DD]">
                        ...
                        <div class="flex items-center gap-3">
                            <div class="relative group cursor-pointer overflow-hidden rounded-xl bg-white border border-[#E6D4DD]" onclick="window.location.reload();">
                                <?php if (!empty($data['captcha_image'])): ?>
                                    <img src="<?= $data['captcha_image'] ?>" alt="CAPTCHA" class="h-12 w-32 object-cover transition-filter group-hover:blur-[1px]">
                                    <div class="absolute inset-0 bg-tlalpan-vino/10 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity">
                            ...
                            <input type="text" name="captcha" placeholder="CÓDIGO" 
                                class="flex-1 bg-white border border-[#E6D4DD] rounded-xl px-4 py-3 text-center font-mono font-black text-lg text-tlalpan-vino focus:border-tlalpan-vino outline-none tracking-widest uppercase">
                        </div>
                    </div>
            ...
            <div class="bg-gray-50 px-8 py-6 text-center border-t border-gray-100">
                <p class="text-[11px] text-gray-400 font-medium">¿Problemas de acceso? <a href="#" class="text-tlalpan-vino font-black hover:underline">Contactar a Soporte</a></p>
            </div>
        </div>
